...
struct MyCustomBenchmarkF : benchmark::Fixture {

  using benchmark::Fixture::Fixture;
  ~MyCustomBenchmarkF() override {}
...
BENCHMARK_DEFINE_F(MyCustomBenchmarkF, copyFuncBenchSetupOne)
...
// algorithms
BENCHMARK_REGISTER_F(MyCustomBenchmarkF, copyFuncBenchSetupOne)
